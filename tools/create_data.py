...
from data_converter import nuscenes_converter_voxel as nuscenes_converter_voxel
...
def nuscenes_data_prep(root_path,
    ...
    assert 'voxel' in info_prefix
    nuscenes_converter_voxel.create_nuscenes_infos(
        root_path, info_prefix, version=version, max_sweeps=max_sweeps)
